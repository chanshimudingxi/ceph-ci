...
class Role(RESTController):
    ...
    def list(self):
        ...
        roles_items = sorted(roles.items(), key=lambda role: role[1].name)
        return [Role._role_to_dict(r) for _, r in roles_items]
