...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  package='proto',
  syntax='proto3',
  serialized_pb=_b('\n\x10mainServer.proto\x12\x05proto\x1a\x1c'
                   'google/api/annotations.proto\"\x07\n\x05\x45mpty\"'
                   '#\n\x10GeneralMsgOutput\x12\x0f\n\x07message'
                   '\x18\x01 \x01(\t\")\n\x16GeneralHeartbeatOutput'
                   '\x12\x0f\n\x07message\x18\x01 \x01(\t\"\x1d\n\n'
                   'PingOutout\x12\x0f\n\x07message\x18\x01 \x01(\t\"*\n\t'
                   'TestInput\x12\x1d\n\x06people\x18\x01 \x03'
                   '(\x0b\x32\r.proto.Person\"\xbe\x01\n\n'
                   'TestOutput\x12\x10\n\x08strArray\x18\x01 \x03('
                   '\t\x12\x31\n\x08mapValue\x18\x02 \x03('
                   '\x0b\x32\x1f.proto.TestOutput.MapValueEntry'
                   '\x12\x19\n\x02pn\x18\x04 \x01(\x0b\x32\r.proto.Person'
                   '\x12\x1f\n\x07profile\x18\x03 \x03('
                   '\x0b\x32\x0e.proto.Profile\x1a/\n\rMapValueEntry'
                   '\x12\x0b\n\x03key\x18\x01 \x01(\t\x12\r\n\x05'
                   'value\x18\x02 \x01(\t:\x02\x38\x01\"\xcf\x01\n\x06'
                   'Person\x12\x0c\n\x04name\x18\x01 \x01(\t\x12\n\n\x02'
                   'id\x18\x02 \x01(\x03\x12\r\n\x05\x65mail'
                   '\x18\x03 \x01(\t\x12)\n\x06phones'
                   '\x18\x04 \x03(\x0b\x32\x19.proto.Person.PhoneNumber'
                   '\x1a\x44\n\x0bPhoneNumber\x12\x0e\n\x06number'
                   '\x18\x01 \x01(\t\x12%\n\x04type\x18\x02 \x01('
                   '\x0e\x32\x17.proto.Person.PhoneType\"+\n\tPhoneType'
                   '\x12\n\n\x06MOBILE\x10\x00\x12\x08\n\x04HOME'
                   '\x10\x01\x12\x08\n\x04WORK\x10\x02\"\xa9\x01\n\x07'
                   'Profile\x12%\n\x08\x66ileInfo\x18\x01 \x01('
                   '\x0b\x32\x13.proto.Profile.File\x1aw\n\x04\x46ile'
                   '\x12\x0c\n\x04name\x18\x01 \x01(\t\x12\x11\n\ttypeInt32'
                   '\x18\x02 \x01(\x05\x12\x11\n\ttypeInt64\x18\x03 \x01('
                   '\x03\x12\x11\n\ttypeFloat\x18\x04 \x01(\x02\x12\x12\n\n'
                   'typeDouble\x18\x05 \x01(\x01\x12\x14\n\x0c\x62ooleanValue'
                   '\x18\x06 \x01(\x08\"4\n\x15GetUsersByStatusInput'
                   '\x12\x0e\n\x06status\x18\x01 \x01(\t\x12\x0b\n\x03key'
                   '\x18\x02 \x01(\t\":\n\x16GetUsersByStatusOutput\x12 \n\x05'
                   'users\x18\x01 \x03(\x0b\x32\x11.proto.UserOutput\")'
                   '\n\x16\x41\x63\x63ountHeartbeatOutput\x12\x0f\n\x07'
                   'message\x18\x01 \x01(\t\"-\n\nLoginInput\x12\r\n\x05\x65'
                   'mail\x18\x01 \x01(\t\x12\x10\n\x08password\x18\x02 \x01'
                   '(\t\"\xc5\x01\n\nUserOutput\x12\n\n\x02id\x18\x01 \x01'
                   '(\t\x12\r\n\x05\x65mail\x18\x02 \x01(\t\x12\x0e\n\x06'
                   'status\x18\x03 \x01(\t\x12\r\n\x05phone\x18\x04 \x01('
                   '\t\x12\x11\n\tfirstName\x18\x05 \x01(\t\x12\x10\n\x08'
                   'lastName\x18\x06 \x01(\t\x12\x13\n\x0b\x63reatedTime'
                   '\x18\x07 \x01(\t\x12\x11\n\tnamespace\x18\x08 \x01('
                   ...
                   'ompany\x18\x06 \x01(\t\"\x1f\n\x0cSingupOutput'
                   '\x12\x0f\n\x07message\x18\x01 \x01(\t\"-\n\x0f\x44\x65'
                   'leteUserInput\x12\r\n\x05\x65mail\x18\x01 \x01('
                   '\t\x12\x0b\n\x03key\x18\x02 \x01(\t\"C\n\x15'
                   'UpdateUserStatusInput\x12\r\n\x05\x65mail\x18\x01 \x01('
                   '\t\x12\x0b\n\x03key\x18\x02 \x01(\t\x12\x0e\n\x06status'
                   '\x18\x03 \x01(\t\"\'\n\x16ResendConfrimCodeInput'
                   '\x12\r\n\x05\x65mail\x18\x01 \x01(\t\"+\n\x0c\x43'
                   'onfirmInput\x12\r\n\x05\x65mail\x18\x01 \x01('
                   '\t\x12\x0c\n\x04\x63ode\x18\x02 \x01(\t\"$\n\x11\x44'
                   'PHeartbeatOutput\x12\x0f\n\x07message\x18\x01 \x01(\t\"'
                   'n\n\x17\x44PGetPhysicalDisksInput\x12\x0f\n\x07hostIds'
                   '\x18\x01 \x01(\t\x12\x0b\n\x03ids\x18\x02 \x01('
                   '\t\x12\r\n\x05limit\x18\x03 \x01(\x03\x12\x0c\n\x04'
                   'page\x18\x04 \x01(\x03\x12\x0c\n\x04\x66rom\x18\x05 \x01('
                   '\t\x12\n\n\x02to\x18\x06 \x01(\t\"{\n\x19\x44'
                   'PGetDisksPredictionInput\x12\x17\n\x0fphysicalDiskIds'
                   '\x18\x01 \x01(\t\x12\x0e\n\x06status\x18\x02 \x01('
                   '\t\x12\r\n\x05limit\x18\x03 \x01(\x03\x12\x0c\n\x04'
                   'page\x18\x04 \x01(\x03\x12\x0c\n\x04\x66rom\x18\x05 \x01('
                   '\t\x12\n\n\x02to\x18\x06 \x01(\t\"\x1e\n\x0e\x44'
                   'PBinaryOutput\x12\x0c\n\x04\x64\x61ta\x18\x01 \x01('
                   '\x0c\",\n\x19\x43ollectionHeartbeatOutput\x12\x0f\n\x07'
                   'message\x18\x01 \x01(\t\"\"\n\x10PostMetricsInput'
                   '\x12\x0e\n\x06points\x18\x01 \x03(\t\" \n\x10'
                   'PostDBRelayInput\x12\x0c\n\x04\x63mds\x18\x01 \x03('
                   '\t\":\n\x17\x43ollectionMessageOutput\x12\x0e\n\x06status'
                   '\x18\x01 \x01(\x03\x12\x0f\n\x07message\x18\x02 \x01(\t2'
                   '\x85\x02\n\x07General\x12\x63\n\x10GeneralHeartbeat'
                   '\x12\x0c.proto.Empty\x1a\x1d.proto.GeneralHeartbeatOutput'
                   '\"\"\x82\xd3\xe4\x93\x02\x1c\x12\x1a/apis/v2/general/'
                   'heartbeat\x12\x46\n\x04Ping\x12\x0c.proto.Empty\x1a\x11.'
                   'proto.PingOutout\"\x1d\x82\xd3\xe4\x93\x02\x17\x12\x15'
                   '/apis/v2/general/ping\x12M\n\x04Test\x12\x10.proto.'
                   'TestInput\x1a\x11.proto.TestOutput\" '
                   '\x82\xd3\xe4\x93\x02\x1a\"\x15/apis/v2/general/test:\x01*2'
                   '\xa4\x06\n\x07\x41\x63\x63ount\x12\x63\n\x10\x41\x63\x63'
                   'ountHeartbeat\x12\x0c.proto.Empty\x1a\x1d.proto.'
                   'AccountHeartbeatOutput\"\"\x82\xd3\xe4\x93\x02\x1c\x12\x1a'
                   '/apis/v2/account/heartbeat\x12N\n\x05Login\x12\x11.proto.'
                   'LoginInput\x1a\x11.proto.UserOutput\"\x1f\x82\xd3\xe4\x93\x02\x19\"\x14'
                   '/apis/v2/users/login:\x01*\x12S\n\x06Signup\x12\x12.proto.'
                   'SingupInput\x1a\x13.proto.SingupOutput\" \x82\xd3\xe4\x93\x02\x1a\"\x15'
                   '/apis/v2/users/signup:\x01*\x12r\n\x11ResendConfrimCode\x12\x1d.proto.'
                   'ResendConfrimCodeInput\x1a\x17.proto.GeneralMsgOutput\"%'
                   '\x82\xd3\xe4\x93\x02\x1f\"\x1a/apis/v2/users/confrimcode:'
                   '\x01*\x12_\n\x07\x43onfirm\x12\x13.proto.ConfirmInput\x1a\x17.proto.'
                   'GeneralMsgOutput\"&\x82\xd3\xe4\x93\x02 \"\x1b/apis/v2/users/confirmation:'
                   '\x01*\x12g\n\x10GetUsersByStatus\x12\x1c.proto.GetUsersByStatusInput\x1a\x1d.'
                   'proto.GetUsersByStatusOutput\"\x16\x82\xd3\xe4\x93\x02\x10\x12\x0e'
                   '/apis/v2/users\x12\x63\n\nDeleteUser\x12\x16.proto.DeleteUserInput'
                   '\x1a\x17.proto.GeneralMsgOutput\"$\x82\xd3\xe4\x93\x02\x1e*\x1c'
                   '/apis/v2/users/{email}/{key}\x12l\n\x10UpdateUserStatus\x12\x1c.'
                   'proto.UpdateUserStatusInput\x1a\x17.proto.GeneralMsgOutput\"!'
                   '\x82\xd3\xe4\x93\x02\x1b\x1a\x16/apis/v2/users/{email}:\x01*2\xcf\x02\n\x0b\x44'
                   'iskprophet\x12T\n\x0b\x44PHeartbeat\x12\x0c.proto.Empty\x1a\x18.proto.'
                   'DPHeartbeatOutput\"\x1d\x82\xd3\xe4\x93\x02\x17\x12\x15/apis/v2/dp/heartbeat'
                   '\x12l\n\x12\x44PGetPhysicalDisks\x12\x1e.proto.DPGetPhysicalDisksInput\x1a\x15'
                   '.proto.DPBinaryOutput\"\x1f\x82\xd3\xe4\x93\x02\x19\x12\x17/apis/v2/'
                   'physical-disks\x12|\n\x14\x44PGetDisksPrediction\x12 .proto.DPGetDisksPredictionInput'
                   '\x1a\x15.proto.DPBinaryOutput\"+\x82\xd3\xe4\x93\x02%\x12#/apis/v2/'
                   'physical-disks/predictions2\xdb\x02\n\nCollection\x12l\n\x13\x43ollectionHeartbeat'
                   '\x12\x0c.proto.Empty\x1a .proto.CollectionHeartbeatOutput\"%'
                   '\x82\xd3\xe4\x93\x02\x1f\x12\x1d/apis/v2/collection/heartbeat\x12o\n\x0b'
                   'PostDBRelay\x12\x17.proto.PostDBRelayInput\x1a\x1e.proto.CollectionMessageOutput'
                   '\"\'\x82\xd3\xe4\x93\x02!\"\x1c/apis/v2/collection/relation:\x01*\x12n\n\x0b'
                   'PostMetrics\x12\x17.proto.PostMetricsInput\x1a\x1e.proto.CollectionMessageOutput'
                   '\"&\x82\xd3\xe4\x93\x02 \"\x1b/apis/v2/collection/metrics:\x01*b\x06proto3'),
...
_RESENDCONFRIMCODEINPUT = _descriptor.Descriptor(
  name='ResendConfrimCodeInput',
  full_name='proto.ResendConfrimCodeInput',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='email', full_name='proto.ResendConfrimCodeInput.email', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
DESCRIPTOR.message_types_by_name['ResendConfrimCodeInput'] = _RESENDCONFRIMCODEINPUT
...
GetUsersByStatusInput = \
  _reflection.GeneratedProtocolMessageType('GetUsersByStatusInput', (_message.Message,), dict(
...
GetUsersByStatusOutput = \
  _reflection.GeneratedProtocolMessageType('GetUsersByStatusOutput', (_message.Message,), dict(
...
AccountHeartbeatOutput = \
  _reflection.GeneratedProtocolMessageType('AccountHeartbeatOutput', (_message.Message,), dict(
...
UpdateUserStatusInput = \
  _reflection.GeneratedProtocolMessageType('UpdateUserStatusInput', (_message.Message,), dict(
...
ResendConfrimCodeInput = \
  _reflection.GeneratedProtocolMessageType('ResendConfrimCodeInput', (_message.Message,), dict(
  DESCRIPTOR = _RESENDCONFRIMCODEINPUT,
  __module__ = 'mainServer_pb2'
  # @@protoc_insertion_point(class_scope:proto.ResendConfrimCodeInput)
  ))
_sym_db.RegisterMessage(ResendConfrimCodeInput)

ConfirmInput = \
  _reflection.GeneratedProtocolMessageType('ConfirmInput', (_message.Message,), dict(
...
DPHeartbeatOutput = \
  _reflection.GeneratedProtocolMessageType('DPHeartbeatOutput', (_message.Message,), dict(
...
DPGetPhysicalDisksInput = \
  _reflection.GeneratedProtocolMessageType('DPGetPhysicalDisksInput', (_message.Message,), dict(
...
DPGetDisksPredictionInput = \
  _reflection.GeneratedProtocolMessageType('DPGetDisksPredictionInput', (_message.Message,), dict(
...
CollectionHeartbeatOutput = \
  _reflection.GeneratedProtocolMessageType('CollectionHeartbeatOutput', (_message.Message,), dict(
...
PostMetricsInput = \
  _reflection.GeneratedProtocolMessageType('PostMetricsInput', (_message.Message,), dict(
...
PostDBRelayInput = \
  _reflection.GeneratedProtocolMessageType('PostDBRelayInput', (_message.Message,), dict(
...
CollectionMessageOutput = \
  _reflection.GeneratedProtocolMessageType('CollectionMessageOutput', (_message.Message,), dict(
...
_TESTOUTPUT_MAPVALUEENTRY._options = \
...
_GENERAL = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    options=_descriptor._ParseOptions(
      descriptor_pb2.MethodOptions(), _b('\202\323\344\223\002\034\022\032/apis/v2/general/heartbeat')),
  ),
  _descriptor.MethodDescriptor(
    name='Ping',
    ...
    options=_descriptor._ParseOptions(
      descriptor_pb2.MethodOptions(), _b('\202\323\344\223\002\027\022\025/apis/v2/general/ping')),
  ),
  _descriptor.MethodDescriptor(
    name='Test',
    ...
    options=_descriptor._ParseOptions(
      descriptor_pb2.MethodOptions(), _b('\202\323\344\223\002\032\"\025/apis/v2/general/test:\001*')),
  ),
])
...
_ACCOUNT = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    options=_descriptor._ParseOptions(
      descriptor_pb2.MethodOptions(), _b('\202\323\344\223\002\034\022\032/apis/v2/account/heartbeat')),
  ),
  _descriptor.MethodDescriptor(
    name='Login',
    ...
    options=_descriptor._ParseOptions(
      descriptor_pb2.MethodOptions(), _b('\202\323\344\223\002\031\"\024/apis/v2/users/login:\001*')),
  ),
  _descriptor.MethodDescriptor(
    name='Signup',
    ...
    options=_descriptor._ParseOptions(
      descriptor_pb2.MethodOptions(), _b('\202\323\344\223\002\032\"\025/apis/v2/users/signup:\001*')),
  ),
  _descriptor.MethodDescriptor(
    name='ResendConfrimCode',
    full_name='proto.Account.ResendConfrimCode',
    index=3,
    containing_service=None,
    input_type=_RESENDCONFRIMCODEINPUT,
    output_type=_GENERALMSGOUTPUT,
    options=_descriptor._ParseOptions(
      descriptor_pb2.MethodOptions(), _b('\202\323\344\223\002\037\"\032/apis/v2/users/confrimcode:\001*')),
  ),
  _descriptor.MethodDescriptor(
    name='Confirm',
    ...
    output_type=_GENERALMSGOUTPUT,
    options=_descriptor._ParseOptions(
      descriptor_pb2.MethodOptions(), _b('\202\323\344\223\002 \"\033/apis/v2/users/confirmation:\001*')),
  ),
  _descriptor.MethodDescriptor(
    ...
    options=_descriptor._ParseOptions(
      descriptor_pb2.MethodOptions(), _b('\202\323\344\223\002\020\022\016/apis/v2/users')),
  ),
  _descriptor.MethodDescriptor(
    name='DeleteUser',
    ...
    output_type=_GENERALMSGOUTPUT,
    options=_descriptor._ParseOptions(
      descriptor_pb2.MethodOptions(), _b('\202\323\344\223\002\036*\034/apis/v2/users/{email}/{key}')),
  ),
  _descriptor.MethodDescriptor(
    ...
    output_type=_GENERALMSGOUTPUT,
    options=_descriptor._ParseOptions(
      descriptor_pb2.MethodOptions(), _b('\202\323\344\223\002\033\032\026/apis/v2/users/{email}:\001*')),
  ),
])
...
_DISKPROPHET = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    options=_descriptor._ParseOptions(
      descriptor_pb2.MethodOptions(), _b('\202\323\344\223\002\027\022\025/apis/v2/dp/heartbeat')),
  ),
  _descriptor.MethodDescriptor(
    ...
    options=_descriptor._ParseOptions(
      descriptor_pb2.MethodOptions(), _b('\202\323\344\223\002\031\022\027/apis/v2/physical-disks')),
  ),
  _descriptor.MethodDescriptor(
    ...
    output_type=_DPBINARYOUTPUT,
    options=_descriptor._ParseOptions(
      descriptor_pb2.MethodOptions(), _b('\202\323\344\223\002%\022#/apis/v2/physical-disks/predictions')),
  ),
])
...
_COLLECTION = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    options=_descriptor._ParseOptions(
      ...
      _b('\202\323\344\223\002\037\022\035/apis/v2/collection/heartbeat')),
  ),
  _descriptor.MethodDescriptor(
    name='PostDBRelay',
    ...
    options=_descriptor._ParseOptions(
      descriptor_pb2.MethodOptions(),
      _b('\202\323\344\223\002!\"\034/apis/v2/collection/relation:\001*')),
  ),
  _descriptor.MethodDescriptor(
    name='PostMetrics',
    ...
    options=_descriptor._ParseOptions(
      descriptor_pb2.MethodOptions(),
      _b('\202\323\344\223\002 \"\033/apis/v2/collection/metrics:\001*')),
  ),
])
