...
int BlueStore::_set_cache_sizes()
{
  ...
  cache_autotune_chunk_size = 
      cct->_conf.get_val<size_t>("bluestore_cache_autotune_chunk_size");
...
int BlueStore::_open_path()
{
  ...
  auto osd_max_object_size =
    cct->_conf.get_val<size_t>("osd_max_object_size");
...
int BlueStore::_balance_bluefs_freespace(PExtentVector *extents)
{
  ...
  uint64_t min_free = cct->_conf.get_val<size_t>("bluestore_bluefs_min_free");
